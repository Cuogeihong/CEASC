...
class RPNHeadExpand(AnchorHead):
    """RPN head.
    ...
    def __init__(self,
        ...
        super(RPNHeadExpand, self).__init__(
    ...
    def loss(self,
        ...
        """
        losses = super(RPNHeadExpand, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def onnx_export(self, x, img_metas):
        ...
        batch_bboxes, batch_scores = super(RPNHeadExpand, self).onnx_export(
